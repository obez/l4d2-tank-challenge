...
WORK_PATH = '' # Working directory, typically this repository (ex: c:\\dev\\maps\\l4d2-tank-challenge\\)
TMP_PATH = WORK_PATH + 'tmp'
SRC_PATH = WORK_PATH + 'src\\'
SCRIPT_PATH = WORK_PATH + 'scripts\\'
VPK_NAME = 'l4d2_tank_challenge'
...
# Other versions
shutil.copy(get_vmf_path('l4d2_tank_challenge'), get_vmf_path('l4d2_tank_challenge_15_rounds'))
shutil.copy(get_vmf_path('l4d2_tank_challenge'), get_vmf_path('l4d2_tank_challenge_20_rounds'))
shutil.copy(get_vmf_path('l4d2_tank_challenge'), get_vmf_path('l4d2_tank_challenge_30_rounds'))
